...
- **Spotify** now-playing with progress bar, **weather**, **time**, **system stats** (CPU/RAM/GPU/network), **heart rate** (Pulsoid / HypeRate), and **AFK** status.
...
4. Follow the in-app setup guide the first time you open it. It walks you through OSC, your first message, and connecting Spotify.
