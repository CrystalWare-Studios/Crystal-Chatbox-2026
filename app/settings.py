...
DEFAULTS = {
    ...
    "song_scroll_enabled": True,
    "lyrics_scroll_enabled": True,
    "window_scroll_enabled": True,
    "heartrate_scroll_enabled": True,
    "weather_scroll_enabled": True,
    "system_stats_scroll_enabled": True,
    "vr_battery_scroll_enabled": True,
    "volume_scroll_enabled": True,
    "device_storage_scroll_enabled": True,
    "afk_scroll_enabled": True,
    "uptime_scroll_enabled": True,
    "total_time_scroll_enabled": True,
